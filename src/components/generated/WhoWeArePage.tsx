...
const FACULTY_GROUPS: FacultyGroup[] = [{
  ...
  members: [{
    ...
    description: "Tumi Mohube is a brand and marketing communications specialist, entrepreneur and senior consultant with over 15 years of experience working with some of South Africa's most recognised brands and organisations across the private and public sectors, with experience spanning industries including FMCG, automotive, services, energy and mining.\nHer career spans both client and agency environments, giving her a well-rounded understanding of how to translate business objectives into effective brand and communications strategies. Her experience includes key account and brand management at South African Breweries, followed by senior leadership roles at The Creative Council, Olive Communications and Publicis Groupe, where she led major local and global blue-chip accounts across FMCG, automotive and services sectors.\nIn 2019, Tumi founded Mohube Media, a brand and communications consultancy specialising in strategic communications, PR, creative strategy and integrated campaign development. Operating through a curated network of specialists, the consultancy delivers across the full communications mix. Her client portfolio includes ACSA, MSC Cruises, Nestlè, DSTV, Distell and AB InBev, among others.\nBeyond her commercial work, Tumi plays an active role in advancing transformation and greater inclusion within South Africa's marketing and communications industry. Through her industry leadership and participation in broader sector and policy engagements, she continues to contribute to conversations shaping the future of the industry and has received international recognition for her work as an entrepreneur and industry leader.\nTumi holds a Postgraduate Diploma in Marketing from the IMM and a National Diploma in Marketing from the University of Johannesburg.",
