...
const FACULTY_GROUPS: FacultyGroup[] = [{
  ...
  members: [{
    ...
    description: 'Doric Sithole is a seasoned communications, marketing, and leadership-development executive with more than 15 years’ experience spanning the private sector, media, government, academia, and international organisations. As Managing Executive of EmpowaHer™ – The Future Is Female™ and former Managing Director of Blue Diamond Communications, she brings deep expertise in strategic communications, brand management, stakeholder engagement, change management, executive coaching, and programme delivery. Her career includes leadership roles at Goldrush Group, Mail & Guardian, the British Council, and the British High Commission, as well as serving as a business coach, facilitator, and pitch judge for the Mastercard Foundation-supported 54Collective Entrepreneurship Academy. Doric is also the co-creator and host of the African Bank and Mail & Guardian-sponsored #UnlockWomen podcast. She holds a BA Honours in Media Studies and a BA in Media Studies and International Relations from the University of the Witwatersrand, where she received the Mellon Mays Foundation Scholarship and Postgraduate Merit Award. A passionate champion of women and emerging entrepreneurs, Doric combines strategic insight, authentic leadership and compelling storytelling to build influential brands, unlock human potential and deliver measurable impact.',
    ...
    name: 'Tumi Mohube',
    role: 'EmpowaWorx Principal Consultant',
    description: 'Tumi Mohube is a brand and marketing communications specialist, entrepreneur, and senior consultant with over 15 years of experience translating business objectives into effective brand and communications strategies across South Africa\'s private and public sectors. As the founder of Mohube Media, she specializes in strategic communications, PR, creative strategy, and integrated campaigns for blue-chip client portfolios including AB InBev, Nestlé, and Distell. An active advocate for transformation and inclusion in the marketing industry, Tumi holds a Postgraduate Diploma in Marketing from the IMM and a National Diploma in Marketing from the University of Johannesburg.',
    image: '/Tumi-Mohube.jpg'
  }, {
